...
export class CircleWave extends Component {
    constructor(props){
        super(props);
        this.status = {
            flag: 0,
            step: 0,
            lines: ['rgba(170,221,255,0.3)',
                'rgba(170,221,255,0.3)',
            ]
        };
    ...
    draw(){
        ...
        let circleRadius = (wave_width )/2.0;
        let circleDistance = wave_width/1.0 ;
