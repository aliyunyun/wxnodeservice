	...
	var App = function (_BaseComponent) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var stepId = Number(obj.stepId);
	            var getUrl = "/v1/app/chairdressing/strategy/stepInfo?appId=10101&stepId=" + stepId + "&timestamp=" + new Date().getTime();
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement('div', { className: 'backgroundGap' }),
	                React.createElement('section', { className: 'details', id: 'details' })
	            );
	        }
	    }]);
	    return App;
