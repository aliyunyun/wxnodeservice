	...
	var App = function (_BaseComponent) {
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var getUrl = "/v1/app/chairdressing/news/details?appId=10101&newsId=" + newsId + "&appType=" + appType + "&timestamp=" + new Date().getTime();
	        ...
	        key: 'formatDate',
	        value: function formatDate(date, format, isUTC) {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    tags.map(function (item, index) {
	                        var first = index == 0 ? 'firstLabel' : '';
	                        return React.createElement(
	                            'label',
	                            { className: 'labelName ' + first, key: index },
	                            '#' + item.tagName
	                        );
	                    })
	                ),
	                ...
	                React.createElement('section', { className: 'articleContent', id: 'articleContent' })
	            );
	        }
	    }]);
	    return App;
