...
class App extends BaseComponent {
    ...
    componentWillMount() {
        ...
        let getUrl = '/v1/app/cms/news/getNews?appId='+appId+'&newsId='+newsId+'&accessToken='+accessToken+'&timestamp='+new Date().getTime();
            ...
            <div className='app-body'>
                <header>
                    ...
                    <div className='headerCon'>
                        ...
                        <span className={this.state.appId == '10131' ?'spanRights':'spanRight'}>
                            <p>
                                <i className='i2'></i>
