...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fun = __webpack_require__(93);
	...
	var App = function (_BaseComponent) {
	    ...
	    function App(props) {
	        ...
	        _this.downLoads = _this.downLoads.bind(_this);
	    ...
	    (0, _createClass3.default)(App, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var appSchemes = obj.appSchemes; //显示隐藏下载栏字段名
	            if (appSchemes) {
	                this.setState({ 'appSchemes': appSchemes });
	            }
	            var newsId = Number(obj.newsId);
	            var accessToken = obj.accessToken || '';
	            var appType = navigator.userAgent.indexOf('Android') > -1 ? 3 : 4;
	            var appId = obj.appId;
	            //let getUrl = 'https://cms.clife.cn/v1/app/cms/news/getNews?appId=10120&newsId=74&accessToken=&timestamp='+new Date().getTime();
	            var getUrl = '/v1/app/cms/news/getNews?appId=' + appId + '&newsId=' + newsId + '&accessToken=' + accessToken + '&timestamp=' + new Date().getTime();
	            _Actions.Actions.getData(getUrl);
	        ...
	        value: function render() {
	            ...
	            var pubTime = _fun.Funs.dateFormat(this.state.pubTime || '', 'yyyy-MM-dd hh:mm:ss', true);
	            if (this.state.appId == '10120') {
	                pubTime = pubTime.Substring(0, pubTime.Length - 3);
	            }
	            var collectCount = this.state.collectCount || 0;
	            var viewsCount = this.state.viewsCount || 0;
	            var downLoad = this.state.appSchemes ? 'downLoad' : 'hide';
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'span',
	                            { className: this.state.appId == '10131' ? 'spanRights' : 'spanRight' },
	                            React.createElement(
	                                'p',
	                                null,
	                                React.createElement('i', { className: 'i2' }),
	                                React.createElement(
	                                    'label',
	                                    null,
	                                    collectCount
	                                ),
	                                React.createElement('i', { className: 'i1' }),
	                                React.createElement(
	                                    'label',
	                                    null,
	                                    viewsCount
	                ...
	                React.createElement(
	                    'section',
	                    { className: 'articleContent', id: 'articleContent' },
	                    ' '
	                ),
	                React.createElement(
	                    'section',
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'span',
	                            { onTouchEnd: this.downLoads },
	                            '\u4E0B\u8F7D\u5E94\u7528'
	                        ),
	                        React.createElement('i', { onTouchStart: this.closed })
	                    )
	                )
	            );
	        }
