...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fun = __webpack_require__(137);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _albums = __webpack_require__(115);

	var _albums2 = _interopRequireDefault(_albums);

	var _albumSongs = __webpack_require__(116);

	var _albumSongs2 = _interopRequireDefault(_albumSongs);

	var _collection = __webpack_require__(125);

	var _collection2 = _interopRequireDefault(_collection);

	var _internal = __webpack_require__(126);

	var _internal2 = _interopRequireDefault(_internal);

	var _localStation = __webpack_require__(127);

	var _localStation2 = _interopRequireDefault(_localStation);

	var _network = __webpack_require__(128);

	var _network2 = _interopRequireDefault(_network);

	var _player = __webpack_require__(129);

	var _player2 = _interopRequireDefault(_player);

	var _recent = __webpack_require__(131);
	...
	var _networkMusic = __webpack_require__(133);

	var _networkMusic2 = _interopRequireDefault(_networkMusic);

	var _buildAlbum = __webpack_require__(134);

	var _buildAlbum2 = _interopRequireDefault(_buildAlbum);

	var _anchors = __webpack_require__(135);

	var _anchors2 = _interopRequireDefault(_anchors);

	var _anchorAlbums = __webpack_require__(136);
	...
	exports.default = RouterDom = React.createElement(
	    ...
	    React.createElement(
	        ...
	        React.createElement(
	            ...
	            React.createElement(Route, { path: 'albums/:id/:title/:playsCount/:tracksCount', component: _networkMusic2.default })
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Page = function (_React$Component) {
	    ...
	    function Page(props) {
	        ...
	        _this.removeListen = _store.locStgStore.listen(_this.setState.bind(_this));
	        return _this;
	    }
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                showFooter && React.createElement(
	                    'footer',
	                    { className: 'footer' },
	                    React.createElement(_salver2.default, { info: currInfo, playing: playing, showPlayList: this.showPlayList.bind(this) })
	                ),
	                React.createElement(_playList2.default, { list: this.state.list, currId: currInfo ? currInfo.mid : -1, ref: 'playList' })
	            );
	        }
	    }]);
	    return Page;
	...
	var Slaver = function (_React$Component) {
		...
		(0, _createClass3.default)(Slaver, [{
			...
			value: function playOrPause(playing) {
				_store.locStgStore.playOrPause(playing);
				this.setState({});
			}
		}, {
			key: 'next',
			value: function next() {
				_store.locStgStore.next();
			}
		}, {
			key: 'link',
			value: function link() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.audio = exports.locStgStore = exports.Internal = exports.Collects = exports.Panel = exports.Records = exports.blueToothTip = undefined;
	...
	var _ajax = __webpack_require__(106);
	...
	*/
	...
	// 是否显示蓝牙配对提示
	var blueToothTip = exports.blueToothTip = {};
	;(function () {
	...
	*/
	...
	;(function () {
		_ajax2.default.getCollectList({}, function (list) {
	...
	*/
	...
	;(function (Ajax) {
		...
		Ajax.getRoomeMusicList({}, function (data) {
			Internal.data = data;
		});
	...
	var locStgStore = exports.locStgStore = Reflux.createStore({

		listenables: [_action.Actions],

		init: function init() {
			var self = this;
			if (!data.currId && data.list.length) data.currId = data.list[0].mid;
		},
		onGetDeviceData: function onGetDeviceData() {
			...
			_ajax2.default.getData(function (res) {
				...
				if (data.speakerPlayStatus == 1) {
					_this2.playInternalMusic();
					_this2.trigger({ currInfo: item, playing: true });

					// 设备传来的音乐为暂定状态并且界面当前音乐为设备内音乐
					// 显示设备内音乐、暂停本地音乐
				} else if (data.speakerPlayStatus == 2 && _this2.playingInternal) {
					_this2.playInternalMusic();
					_this2.trigger({ currInfo: item, playing: false });
				}
			});
		},
		onSetDeviceData: function onSetDeviceData(data, item) {
			var _this3 = this;

			_ajax2.default.setMusicControl(data, function () {
				audio.pause();
		...
		// 播放设备内音乐
		playInternalMusic: function playInternalMusic() {
		...
		// 播放或暂停
		playOrPause: function playOrPause(playing) {

			if (this.playingInternal) {

				_ajax2.default.setMusicControl({ speakerPlayStatus: playing ? 2 : 1 });
		...
		// 根据id播放指定歌曲
		change: function change(id, pause) {
		...
		addToNext: function addToNext(items) {
			...
			if (items.length) {
				...
				(_data$list = data.list).splice.apply(_data$list, [data.currId, 0].concat((0, _toConsumableArray3.default)(items)));
				setLocalStorage('list', data.list);
				this.trigger({ list: data.list });
		...
		getNoExistItems: function getNoExistItems(items) {
			...
			var arr = [];
			items.forEach(function (item) {
				if (!_this4.isExist(item.mid)) arr.push(item);
			});
			return arr;
		},
		...
		isExist: function isExist(id) {
			for (var i = 0; i < data.list.length; i++) {
				if (data.list[i].mid == id) return true;
			}
			return false;
		},
		...
		// 指定删除
		removes: function removes(ids) {
			(typeof ids === 'undefined' ? 'undefined' : (0, _typeof3.default)(ids)) !== 'object' && (ids = [ids]);
			var list = data.list;
			var currId = data.currId;
...
/***/ function(module, exports) {
	...
	'getList', 'setDeviceData', 'getDeviceData', 'getRunData', 'getConfigData', 'changeColor', 'changeMode', 'changeBrightness', 'changeMist', 'changeCloseTime', 'changeSwitch', 'getRecentlyColor', 'getDisplayData', 'changeOrderInfo']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadsh = __webpack_require__(107);
	...
	exports.default = Ajax = {
		...
		playMusicControl: function playMusicControl(data, suc, err) {
			data.playStatus = 1;
			setMusicControl(data, suc, err);
		},
		pauseMusicControl: function pauseMusicControl(data, suc, err) {
			data.playStatus = 2;
			setMusicControl(data, suc, err);
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	if("function"=='function'&&(0,_typeof3.default)(__webpack_require__(109))=='object'&&__webpack_require__(109)){// Expose lodash to the global object when an AMD loader is present to avoid
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iscrollProbe = __webpack_require__(111);
			...
			value: function render() {
				...
				if (list.length) {
					arr = list.map(function (item, i) {
						...
						return React.createElement(
							'li',
							{ key: i, className: '' + (currId == mid ? 'selected' : ''), onTouchTap: _store.locStgStore.change.bind(_this4, mid) },
							React.createElement(
								'div',
								null,
								React.createElement(
								...
								React.createElement('i', { className: 'del_icon', onTouchTap: _this4.del.bind(_this4, mid) })
							)
						);
					});
				} else {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('i', { className: 'clear_icon', onTouchTap: this.clearList.bind(this) })
						),
						React.createElement(
							'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tips = __webpack_require__(113);
	...
	var Home = function (_React$Component) {
	    ...
	    function Home(props) {
	        ...
	        _loadsh2.default.assign(_this.opts, _this.props);
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseModule = __webpack_require__(121);

	var _baseModule2 = _interopRequireDefault(_baseModule);

	var _songList = __webpack_require__(124);
	...
	var AlbumSongs = function (_BaseModule) {
		...
		(0, _createClass3.default)(AlbumSongs, [{
			...
			value: function moreOpea(item) {
				...
				this.state.toolbar.tools = [{ name: 'toAlbum' }, { name: 'collect', hasCollect: _store.Collects.has(item) }, { name: 'edit', fun: function fun() {
						self.onEditAlbum();
					}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _albumsPop = __webpack_require__(123);
	...
	var BaseModule = function (_React$Component) {
		...
		(0, _createClass3.default)(BaseModule, [{
			...
			value: function setSimpleTools(item) {
				...
				this.state.toolbar.tools = [{ name: 'toNext' }, { name: 'toAlbum' }, { name: 'collect', hasCollect: _store.Collects.has(item) }, { name: 'delete' }];
			}
		}, {
			key: 'toolEvent',
			value: function toolEvent() {
				...
				return {
					...
					toNext: function toNext() {
						...
						_store.locStgStore.addToNext(items);
						self.reset();
					},
					...
					collect: function collect() {
						...
						if (self.state.toolType == 'single' && _store.Collects.has(items[0])) {
							_ajax2.default.deleteMusicFromCustomAlbum({ musicList: musicList }, function (res) {
								if (res.code == 0) {
									_store.Collects.remove(items);
			...
			value: function onPlayAll() {
				...
				if (list && list.length) {
					_store.locStgStore.clear();
					_store.locStgStore.addToNext(list);
					_store.locStgStore.play(list[0]);
				}
			}
		}, {
			key: 'onSelectAll',
			...
			value: function toolEvent() {
				...
				events.delete = function () {
					...
					supDelete(function (items) {
						...
						_ajax2.default.deleteMusicFromCustomAlbum({ list: musicList }, function (data) {
							self.refs.tips.showMsg('删除成功');
						});
					});
				};
	...
	var Internal = function (_React$Component) {
		...
		(0, _createClass3.default)(Internal, [{
			...
			value: function componentDidMount() {
				...
				_ajax2.default.getRoomeMusicList({}, function (data) {
					// TODO 异常处理
					var currId = _store.Panel.getId('internal') || data[0].subCategoryId;
			...
			value: function onTouchItem(item) {
				...
				_action.Actions.setDeviceData({ musicId: item.id, speakerPlayStatus: 1 }, item);
			}
		}, {
			key: 'selectPanel',
			value: function selectPanel(pid) {
				_store.Panel.setId('internal', pid);
						...
						React.createElement(
							...
							React.createElement(
								...
								list.map(function (item, i) {
									return React.createElement(
										'li',
										{ key: item.id, onTouchTap: _this4.onTouchItem.bind(_this4, item) },
										React.createElement(
											'span',
											null,
											item.name
		...
		(0, _createClass3.default)(LocalStation, [{
			...
			value: function getData() {
				...
				_ajax2.default.getLocalRadio({ paged: false }, function (data) {
					_this2.loaded = true;
					var currId = _store.Panel.getId('localStation') || data[0].subCategoryId;
					_this2.setState({ panels: data, currId: currId });
					_this2.refreshScroll();
				});
			}
			...
			key: 'selectPanel',
			value: function selectPanel(pid) {
				_store.Panel.setId('localStation', pid);
				this.setState({ currId: pid });
				this.refreshScroll();
			}
		}, {
			key: 'setSimpleTools',
			value: function setSimpleTools(item) {
				this.state.toolbar.tools = [{ name: 'toNext' }, { name: 'toAlbum' }, { name: 'collect', hasCollect: _store.Collects.has(item) }];
			}
		}, {
			key: 'onTouchItem',
			value: function onTouchItem(item) {
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							this.state.panels.map(function (item, i) {
								var pid = item.subCategoryId;
								if (_this3.state.currId == pid) list = item.radiosList;
								return React.createElement(
									'span',
						...
						React.createElement(
							...
							React.createElement(
								...
								list.map(function (item, i) {
									...
									return React.createElement(
										'li',
										{ key: newItem.mid, onTouchTap: _this3.onTouchItem.bind(_this3, newItem) },
										React.createElement(
											'span',
											null,
											newItem.name
										...
										React.createElement(
											'div',
											{ className: 'oper_icon', onTouchTap: _this3.onTouchOper.bind(_this3, newItem) },
											React.createElement('i', null)
										)
									);
								})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Network = function (_React$Component) {
		...
		function Network(props) {
			...
			var _this = (0, _possibleConstructorReturn3.default)(this, (Network.__proto__ || (0, _getPrototypeOf2.default)(Network)).call(this, props));

			_this.panels = [{ id: '1', text: '推荐' }, { id: '2', text: '分类' }, { id: '3', text: '主播' }];
			_this.state = {};
		...
		(0, _createClass3.default)(Network, [{
			...
			value: function componentDidMount() {
				document.title = '喜马拉雅';
				this.myScroll = new _iscrollProbe2.default('#wrapper', { mouseWheel: true });
				var currPanelId = _store.Panel.getId('network') || 1;
	...
	var Item = function (_React$Component2) {
		...
		(0, _createClass3.default)(Item, [{
			key: 'link',
			value: function link(id, title, playsCount, tracksCount) {
					...
					React.createElement(
						...
						albumsList && albumsList.map(function (item, i) {
							return React.createElement(
								...
								React.createElement(
									'div',
									{ onTouchTap: _this6.link.bind(_this6, item.id, item.title, item.playsCount, item.tracksCount) },
	...
	var Player = function (_BaseModule) {
		...
		(0, _createClass3.default)(Player, [{
			...
			value: function collect(item) {
				...
				if (_store.Collects.has(item)) {
					_ajax2.default.deleteMusicFromCustomAlbum({ musicList: musicList }, function (res) {
						if (res.code == 0) {
							_store.Collects.remove(item);
			...
			value: function render() {
				...
				var status = _store.audio.paused ? 'start' : 'stop';
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'head_img' },
								React.createElement('img', { className: _store.audio.paused ? '' : 'music_img', src: mmi || '../static/imgs/pic-74@2x.png' })
							)
						),
						React.createElement(
							'div',
							...
							React.createElement(
								'div',
								null,
								React.createElement('i', { className: _store.Collects.has(item) ? 'collected' : 'uncollected', onTouchTap: this.collect.bind(this, item) })
							),
							React.createElement(
								'div',
								null,
								React.createElement('i', { className: 'mode mode' + this.props.mode, onTouchTap: _store.locStgStore.changeMode.bind(_store.locStgStore) })
							),
							React.createElement(
								'div',
								null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Recent = function (_BaseModule) {
		...
		function Recent(props) {
			...
			_loadsh2.default.extend(_this.state, {});
			_this.state.toolbar.events = _this.toolEvent();
			_this.state.songs.list = _store.Records.getList();
			return _this;
		}
	...
	var Network = function (_React$Component) {
		...
		(0, _createClass3.default)(Network, [{
			...
			value: function componentDidMount() {
				...
				if (cid == 99) {
					...
					_ajax2.default.getSubCategroyList({ categoryId: 1 }, function (res) {
						...
						currPanelItem = _this2.getPanelItem(_store.Panel.getId('tags'), res.data);
					...
					_ajax2.default.getXmlyCategoryTags({ category_id: cid, type: 0 }, function (data) {
						...
						currPanelItem = _this2.getPanelItem(_store.Panel.getId('tags'), data);
			...
			value: function getAlbums(item) {
				...
				_store.Panel.setId('tags', item.subCategoryId || item.tag_name);
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									this.state.panels.map(function (item, i) {
										...
										return React.createElement(
											'div',
											{ className: 'tag_item ' + (_this5.state.currTag == name ? 'selected' : '') },
											React.createElement(
												'span',
												{ key: name, onTouchTap: _this5.getAlbums.bind(_this5, item) },
												name
											)
										);
									})
							...
							React.createElement(
								'span',
								{ className: 'more' },
								React.createElement('i', { className: 'arrow_bottom ' + (showMore ? 'roate_top' : 'roate_bottom'), onTouchEnd: this.toggle.bind(this) })
							)
						)
					),
					React.createElement(
		...
		(0, _createClass3.default)(Item, [{
			...
			value: function render() {
				...
				html = list.map(function (item) {
					...
					return React.createElement(
						'li',
						{ key: item.id, onTouchTap: _this7.link.bind(_this7, item.id, item.album_title, item.play_count, item.include_track_count) },
						React.createElement(
							'div',
							{ className: 'img_wrap' },
	...
	var NetworkMusic = function (_BaseModule) {
		...
		(0, _createClass3.default)(NetworkMusic, [{
			...
			value: function getData() {
				...
				_ajax2.default.getXmlyAlbumMusics({ album_id: this.props.params.id, count: this.pageSize }, function (data) {
					_this2.loaded = true;
			...
			value: function render() {
				var _props$params = this.props.params;
				var playsCount = _props$params.playsCount;
				var tracksCount = _props$params.tracksCount;
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'group_info', style: { backgroundImage: 'url(' + cover_url_large + ')' } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*require('../libs/iscroll-probe');*/

	var _ReactRouter = ReactRouter;
	/*require('../../../../common/static/iscroll5');*/
		...
		(0, _createClass3.default)(Item, [{
			...
			value: function render() {
				...
				html = list.map(function (item) {
					...
					return React.createElement(
						'li',
						{ key: item.id, onTouchTap: _this5.link.bind(_this5, item.id, item.album_title, item.play_count, item.include_track_count) },
						React.createElement(
							'div',
							{ className: 'img_wrap' },
							React.createElement('img', { src: item.cover_url_small })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fun = __webpack_require__(138);
